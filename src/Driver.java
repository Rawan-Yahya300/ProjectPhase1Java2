...
public class Driver {
	...
	public static void main(String[] args) {
		...
		int process = 0;
		repeatAskForInt(process, "Enter a process");
		...
		while (process != 15) {
			...
			case 1: { // to add new family
				...
				if (manager.addFamily(family)) { // if the adding of family is true , ask about mom and dad
					...
					System.out.println(
							"Does Dad Martyr or Live Person?\nif he is Martyr enter number 1 , if she is Live Person enter number 2");// ask
																																		// about
																																		// the
																																		// dad
			...
			case 2: { // to add member
				System.out.println(
						"The member is Martyr or Live Person?if he/she is Martyr enter number 1 ,if he/she is Live Person enter number 2");// ask
																																			// the
																																			// user
																																			// if
																																			// the
				...
				System.out.println("Enter the family number you want to add member to it: ");// ask about family number
																								// that the user want to
																								// add member to it
				...
				System.out.println("The member is son or daughter, if son enter 1,if daugther enter number 2:"); // Ask
																													// the
																													// user
																													// if
																													// the
				...
				case 2: {
					...
					} else if (sOd == 2) { // if the member is daughter , add him to the family as live person and
											// daughter
						if (familyNum - 1 < manager.getFamilies().size()
			...
			case 3: { // to remove member
				...
				System.out.println(manager.toString());
				System.out.println("Enter the family number you want to remove member from it: "); // Ask user to enter
																									// the number of
																									// family to add the
																									// member from it
				int familyNum = input.nextInt();
				...
				if (familyNum - 1 < manager.getFamilies().size()) { // if the family is exist
					System.out.println(manager.getFamilies().get(familyNum - 1).toStringWithId()); // display the family
																									// members with
																									// their ID
					System.out.println("Enter the ID for the member you want to delete: ");// Ask the user to enter the
																							// ID for member to remove
																							// it
					String IDtoRemove = input.next();
					for (int i = 0; i < manager.getFamilies().get(familyNum - 1).getMembers().size(); i++) { // looking
																												// for
																												// about
																												// the
																												// member
						...
						if (IDtoRemove.equals(manager.getFamilies().get(familyNum - 1).getMembers().get(i).getID())) {
							is = true;
							manager.getFamilies().get(familyNum - 1)
									.removeMember(manager.getFamilies().get(familyNum - 1).getMembers().get(i));
			...
			case 4: { // to remove family
				System.out.println("All families: "); // display all families
				System.out.println(manager.toString());
				System.out.println("Enetr the family name you want  to delete: "); // Ask the user to enter the number
																					// of family to remove it
				String familyName = input.next();
			...
			case 7: { // baaaaaaaack
				System.out.println("Enter the family name you want to update it: ");// ask the user to enter the name
																					// family to update it
				String familyName = input.next();
				...
				System.out.println("Enter the name of new family: "); // Ask about the name of new family and its dad
																		// and mom
				String familyNameNew = input.next();
				Family family = new Family(familyNameNew);
				System.out.println(
						"Does Mom Martyr or Live Person?\nif she is Martyr enter number 1 , if she is Live Person enter number 2");// ask
																																	// if
																																	// the
																																	// mom
																																	// martyr
			...
			case 13: { // to test if the two family are equal in number of martyr
				...
				if (numOfFamily1 - 1 < manager.getFamilies().size()
						&& numOfFamily2 - 1 < manager.getFamilies().size()) { // if the two families are exist invoke
																				// the method
	...
	public static void repeatAskForInt(int x, String message) {
	...
	/**
	 * 
	 * @param x       // the String you want from the user to enter it
	 * @param message //the message apears to user to understand what he/she should
	 *                enter
	 */
//	public static void repeatAskForString(String x, String message) {
//		boolean isValid = false;
//
//		while (isValid == false) {
//			try {
